...
<!-- sidebar stop -->
<!-- blog cards start -->
<div class="col-lg-9  py-5" style="float: right;">


<div class="alert alert-success mx-3" role="alert">
  <p class="m-0">Related Post To : <span class="fw-bold"><?php echo $_GET['search'] ?></span></p>
</div>
        ...
        if($results->num_rows > 0){
          while($row = $results->fetch_assoc()){
            ...
            $post_category = $conn->query($categoryid)->fetch_assoc();
              if(str_contains(strtolower($row["title"]) , strtolower($search))){
          ...
          <img src="./upload/picture/<?php echo $row["img"] ?>" alt="">
            ...
            <h5 class="h5 fw-bold card-title">
              ...
              <p class="card-text m-0">
                <?php echo substr($row["body"] , 0 , 120) . "..."; ?>
              </p>
