...
<div style="width: 80%; height: 90%;" class="d-flex flex-column flex-shrink-0 p-3 overflow-auto float-end">
    <div class="px-3 pt-2">
        ...
        <div class="col-md-2 float-end" style="margin-top: -30px;">
            <a href="new_blogs" class="btn btn-outline-success px-2 py-1" type="submit">Create New Post</a>
        </div>
        <hr>
            <?php
        ...
        <div class="mb-3 bg-white rounded-3 px-4 pb-2 pt-4 part-dashboard last-blogs">
            ...
            <?php
                $post = "SELECT id, title, category_id, body, author, img FROM posts ORDER BY id";
            ...
            <tbody>
                ...
                ?>
                    ...
                    <a href="blogs?type=post&action=delete&id=<?php echo $row["id"] ?>" class="btn btn-outline-danger px-2 py-1" type="submit">Delete</a>
                    </td>
                    </tr>
                <?php
                        }
